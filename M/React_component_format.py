# Step 6: Create a simple React frontend component (our recommended frontend framework)
react_component = '''
...
with open('SepsisPredictor.tsx', 'w') as f:
    f.write(react_component)

print("=== STEP 6: REACT FRONTEND COMPONENT CREATED ===\n")
print("React TypeScript component created: SepsisPredictor.tsx")
print("\nFeatures:")
...
print("1. npm install axios")
print("2. Install Tailwind CSS for styling")
print("3. Import and use <SepsisPredictor /> component")
print("4. Ensure FastAPI backend is running on port 8000")